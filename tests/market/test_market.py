...
def test_exact_match():
    ...
    market.submit_(BuyOrder.public(market.accounts[0], price=0.5, volume=1))
    market.submit_(SellOrder.public(market.accounts[1], price=0.5, volume=1))
...
def test_price_mismatch():
    ...
    market.submit_(BuyOrder.public(market.accounts[0], price=2, volume=1))
    market.submit_(SellOrder.public(market.accounts[1], price=3, volume=1))
...
def test_crossed_price():
    ...
    market.submit_(BuyOrder.public(market.accounts[0], price=3, volume=1))
    market.submit_(SellOrder.public(market.accounts[1], price=2, volume=1))
    assert market.orders == []
...
def test_multiple_matches():
    ...
    market.submit_(BuyOrder.public(market.accounts[0], price=1, volume=1))
    market.submit_(BuyOrder.public(market.accounts[0], price=2, volume=1))
    market.submit_(BuyOrder.public(market.accounts[0], price=3, volume=1))
    market.submit_(SellOrder.public(market.accounts[1], price=2, volume=1.5))
    assert market.orders == [
        BuyOrder.public(market.accounts[0], price=1, volume=1),
        BuyOrder.public(market.accounts[0], price=2, volume=0.5),
    ]
...
def test_exhausting_orderbook():
    ...
    market.submit_(SellOrder.public(market.accounts[0], price=3, volume=1))
    market.submit_(SellOrder.public(market.accounts[0], price=1, volume=1))
    market.submit_(SellOrder.public(market.accounts[0], price=2, volume=1))
    market.submit_(BuyOrder.public(market.accounts[1], price=4, volume=8))
    assert market.orders == [BuyOrder.public(market.accounts[1], price=4, volume=5)]
